...
class PipelineRunner:
    ...
    def __init__(
        ...
        custom_image_config: Optional[CustomImageConfig] = None,
    ):
        """
        ...
        Args:
            ...
            custom_image_config: Optional. Configuration to automatically build and use a custom base image for the pipeline components. This is useful when:
        ...
        self.custom_image_config = custom_image_config
    ...
    def run(
        ...
        Args:
            ...
            force_image_rebuild: Optional. Relavent only if the `custom_image_config` argument is passed to the `PipelineRunner`. If set to True, existing images in the Artifact Registry repository with the same hash tag will be ignored, and the component base image will be rebuilt, even if the code in `src_dir` hasn't changed.
